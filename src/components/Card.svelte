...
<div class="bg-gray-800 shadow-lg rounded-lg shadow-gray-950 w-96 min-h-[10rem] overflow-hidden text-center relative">
  <h1 class="text-white font-semibold mb-2 ml-2 mr-2">{name}</h1>
